...
| `bookstack pages move <id>` | Move page to different book/chapter (`--book-id`, `--chapter-id`) |
| `bookstack pages copy <id>` | Copy page to different book/chapter (`--book-id`, `--name`) |
